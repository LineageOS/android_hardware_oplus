...
static int amp_module_open(const hw_module_t* module, const char* name, hw_device_t** device) {
    ...
    tfa_dev->enable_snd_device =
            (typeof(tfa_dev->enable_snd_device))dlsym(RTLD_NEXT, "enable_snd_device");
    tfa_dev->enable_audio_route =
            (typeof(tfa_dev->enable_audio_route))dlsym(RTLD_NEXT, "enable_audio_route");
    tfa_dev->disable_snd_device =
            (typeof(tfa_dev->disable_snd_device))dlsym(RTLD_NEXT, "disable_snd_device");
    tfa_dev->disable_audio_route =
            (typeof(tfa_dev->disable_audio_route))dlsym(RTLD_NEXT, "disable_audio_route");
    tfa_dev->platform_get_pcm_device_id = (typeof(tfa_dev->platform_get_pcm_device_id))dlsym(
            RTLD_NEXT, "platform_get_pcm_device_id");
    tfa_dev->get_usecase_from_list =
            (typeof(tfa_dev->get_usecase_from_list))dlsym(RTLD_NEXT, "get_usecase_from_list");
