...
struct FusionConfig {
    ...
    int32_t sf_screenshot_cal_delay_ns = 0;
    int32_t sf_screenshot_cal_delay_90_ns = 0;
    int32_t sf_screenshot_cal_delay_60_ns = 0;
    int32_t sf_screenshot_period_millis = 0;
    double sf_screenshot_match_ratio_threshold = 0.0;
