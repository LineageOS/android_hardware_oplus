...
class ButtonSettingsFragment : PreferenceFragmentCompat() {
    ...
    private fun setupPreferenceLogic(
        ...
        if (controllerPref == null || dependentDndPref == null || ringerPref == null) {
            ...
            Log.e(
                ...
                "Preferences not found for (at least one of these) keys: $controllerKey, $dependentKey, $ringerKey",
            )
            return
        }
        ...
        Log.d(
            "ButtonSettingsFragmentA",
            "DND Entries: L${dndEntries.size} ${dndEntries.joinToString()}",
        )
        Log.d(
            "ButtonSettingsFragmentA",
            "DND Entry Values: L${dndEntryValues.size} ${dndEntryValues.joinToString()}",
        )
    ...
    private fun updateRingerPreferenceVisibility(
        ...
        Log.d(
            "ButtonSettingsFragmentA",
            "Ringer Preference ${ringerPreference.key} visibility set to ${ringerPreference.isVisible}",
        )
    ...
    private fun updateDndPreferenceVisibility(dndPreference: Preference, controllerValue: String?) {
        ...
        Log.d(
            "ButtonSettingsFragmentA",
            "DND Preference ${dndPreference.key} visibility set to ${dndPreference.isVisible}",
        )
        ...
        if (dndPreference.isVisible) {
            ...
            if (listPref.value == null || listPref.value!!.isEmpty()) {
                ...
                Log.d(
                    "ButtonSettingsFragmentA",
                    "DND Preference ${dndPreference.key} value set to $firstValue",
                )
            }
        }
    }
    ...
    /**
     * Define the keys for your preferences. These MUST match the android:key attributes in your
     * R.xml.button_panel
     */
    companion object {
