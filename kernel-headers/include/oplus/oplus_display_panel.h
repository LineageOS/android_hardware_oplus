...
#define PANEL_IOCTL_SET_PWM_PULSE _IOW(OPLUS_PANEL_IOCTL_BASE, 0x72, unsigned int)
#define PANEL_IOCTL_GET_PWM_PULSE _IOWR(OPLUS_PANEL_IOCTL_BASE, 0x73, unsigned int)
