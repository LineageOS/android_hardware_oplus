...
int main() {
    ...
    std::shared_ptr<HighTouchPollingRate> hightouchpollingrate =
    ...
    binder_status_t status =
            AServiceManager_addService(hightouchpollingrate->asBinder().get(), instance.c_str());
    ...
    binder_status_t status2 =
            AServiceManager_addService(touchscreengesture->asBinder().get(), instance2.c_str());
