...
int main() {
    ...
    binder_status_t status =
            AServiceManager_addService(highToushPollingRateService->asBinder().get(), instance.c_str());
    ...
    status = AServiceManager_addService(touchscreenGestureService->asBinder().get(), instance.c_str());
