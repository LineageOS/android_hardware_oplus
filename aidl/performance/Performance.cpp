...
ndk::ScopedAStatus Performance::addAcmDirName(const std::string& in_dirname, int64_t in_flag, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": dirname=" << in_dirname << ", flag=" << in_flag;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::addAcmNomediaDirName(const std::string& in_dirname, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": dirname=" << in_dirname;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::addAcmPkgName(const std::string& in_pkgname, int64_t in_flag, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": pkgname=" << in_pkgname << ", flag=" << in_flag;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::addTaskTrackPid(int32_t in_group, int32_t in_pid, bool in_clear, int32_t* _aidl_return) {
...
ndk::ScopedAStatus Performance::delAcmDirName(const std::string& in_dirname, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": dirname=" << in_dirname;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::delAcmNomediaDirName(const std::string& in_dirname, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": dirname=" << in_dirname;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::delAcmPkgName(const std::string& in_pkgname, int32_t* _aidl_return) {
...
ndk::ScopedAStatus Performance::enableAudioPerf(const std::string& in_value, int32_t* _aidl_return) {
...
ndk::ScopedAStatus Performance::getAcmDirFlag(const std::string& in_dirname, int64_t* _aidl_return) {
    LOG(INFO) << __func__ << ": dirname=" << in_dirname;
    *_aidl_return = 0L;
    return ndk::ScopedAStatus::ok();
}
...
ndk::ScopedAStatus Performance::getAcmPkgFlag(const std::string& in_pkgname, int64_t* _aidl_return) {
    LOG(INFO) << __func__ << ": pkgname=" << in_pkgname;
    *_aidl_return = 0L;
    return ndk::ScopedAStatus::ok();
}
...
ndk::ScopedAStatus Performance::getClmThreshold(int32_t in_threshold_id, std::string* _aidl_return) {
...
ndk::ScopedAStatus Performance::getExt4FragScore(const std::string& in_devpath, std::string* _aidl_return) {
    LOG(INFO) << __func__ << ": devpath=" << in_devpath;
    *_aidl_return = "";
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::getExt4FreefragInfo(const std::string& in_devpath, std::string* _aidl_return) {
    LOG(INFO) << __func__ << ": devpath=" << in_devpath;
    *_aidl_return = "";
    return ndk::ScopedAStatus::ok();
}
...
ndk::ScopedAStatus Performance::getWakeThreadsAffinityOrdered(const std::string& in_handle, int32_t in_size, TaskWakeInfo* _aidl_return) {
...
ndk::ScopedAStatus Performance::hybridswap_memcg_para_read(int32_t in_action, const std::string& in_cgroup, std::string* _aidl_return) {
    LOG(INFO) << __func__ << ": action=" << in_action << ", cgroup=" << in_cgroup;
    *_aidl_return = "";
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::hybridswap_memcg_para_write(int32_t in_action, const std::string& in_cgroup, const std::string& in_str, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": action=" << in_action << ", cgroup=" << in_cgroup << ", str=" << in_str;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::hybridswap_zram_para_read(int32_t in_action, std::string* _aidl_return) {
    LOG(INFO) << __func__ << ": action=" << in_action;
    *_aidl_return = "";
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::hybridswap_zram_para_write(int32_t in_action, const std::string& in_str, int32_t* _aidl_return) {
...
ndk::ScopedAStatus Performance::perProcessMemReadahead(int32_t in_uid, int32_t in_pid, int32_t in_type, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": uid=" << in_uid << ", pid=" << in_pid << ", type=" << in_type;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::perProcessMemReclaim(int32_t in_uid, int32_t in_pid, int32_t in_type, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": uid=" << in_uid << ", pid=" << in_pid << ", type=" << in_type;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}
...
ndk::ScopedAStatus Performance::readIomonitorInfo(const std::string& in_procname, std::string* _aidl_return) {
...
ndk::ScopedAStatus Performance::readMemoryByPids(const std::vector<int32_t>& in_pids, int32_t in_flags, ProcMemStatRet* _aidl_return) {
    LOG(INFO) << __func__ << ": pids.size=" << in_pids.size() << ", flags=" << in_flags;
    *_aidl_return = {};
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::readMemoryByUids(const std::vector<int32_t>& in_uids, int32_t in_flags, ProcMemStatRet* _aidl_return) {
    LOG(INFO) << __func__ << ": uids.size=" << in_uids.size() << ", flags=" << in_flags;
    *_aidl_return = {};
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::readNandswapProc(const std::string& in_inProc, std::string* _aidl_return) {
...
ndk::ScopedAStatus Performance::readOplusReserve3(int32_t in_offset, int32_t in_len, std::string* _aidl_return) {
...
ndk::ScopedAStatus Performance::readStorageFeature(const std::string& in_name, const std::string& in_addr, const std::string& in_isMulti, std::string* _aidl_return) {
    LOG(INFO) << __func__ << ": name=" << in_name << ", addr=" << in_addr << ", isMulti=" << in_isMulti;
    *_aidl_return = "";
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::readTargetProcess(const std::string& in_buffer, std::string* _aidl_return) {
...
ndk::ScopedAStatus Performance::readUxTaskTrack(int32_t in_uPid, int32_t in_rPid, std::string* _aidl_return) {
...
ndk::ScopedAStatus Performance::searchAcmNomediaDirName(const std::string& in_dirname, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": dirname=" << in_dirname;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}
...
ndk::ScopedAStatus Performance::setClmThreshold(const std::string& in_buffer, int32_t in_threshold_id) {
    LOG(INFO) << __func__ << ": buffer=" << in_buffer << ", threshold_id=" << in_threshold_id;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::setDamonReclaimColdTime(int32_t in_cold_time, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": cold_time=" << in_cold_time;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::setDamonReclaimMonitoring(int32_t in_sample, int32_t in_aggr, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": sample=" << in_sample << ", aggr=" << in_aggr;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::setDamonReclaimQuota(int32_t in_quota_ms, int32_t in_quota_sz, int32_t in_reset_interval, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": quota_ms=" << in_quota_ms << ", quota_sz=" << in_quota_sz << ", reset_interval=" << in_reset_interval;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::setDamonReclaimWmarks(int32_t in_metric, int32_t in_high, int32_t in_mid, int32_t in_low, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": metric=" << in_metric << ", high=" << in_high << ", mid=" << in_mid << ", low=" << in_low;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::setExtSchedProp(const std::string& in_pid, const std::string& in_prop) {
...
ndk::ScopedAStatus Performance::setFreqGoverner(const std::string& in_gov_name, const std::vector<int32_t>& in_clusters, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": gov_name=" << in_gov_name << ", clusters.size=" << in_clusters.size();
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::setImFlag(const std::string& in_pid, const std::string& in_im_flag) {
    LOG(INFO) << __func__ << ": pid=" << in_pid << ", im_flag=" << in_im_flag;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::setProcessReclaim(const std::string& in_info, int32_t* _aidl_return) {
...
ndk::ScopedAStatus Performance::setTpdSerialParams(const std::string& in_params, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": params=" << in_params;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::setWakeSeedThread(const std::string& in_tid, bool in_identify_type, bool in_inUid, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": tid=" << in_tid << ", identify_type=" << in_identify_type << ", inUid=" << in_inUid;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}
...
ndk::ScopedAStatus Performance::writeKmallocDebugCreateWithType(const std::string& in_type, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": type=" << in_type;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::writeMemMonitor(const std::string& in_buffer, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": buffer=" << in_buffer;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::writeMemleakDetectThread(int32_t in_memdect, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": memdect=" << in_memdect;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::writeMonitorStatus(const std::string& in_buffer, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": buffer=" << in_buffer;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::writeNandswapProc(const std::string& in_inProc, const std::string& in_cmd, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": inProc=" << in_inProc << ", cmd=" << in_cmd;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::writeOplusReserve3(int32_t in_offset, int32_t in_len, const std::string& in_info, int32_t* _aidl_return) {
...
ndk::ScopedAStatus Performance::writeStorageFeature(const std::string& in_name, const std::string& in_addr, const std::string& in_isMulti, const std::string& in_cmd, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": name=" << in_name << ", addr=" << in_addr << ", isMulti=" << in_isMulti << ", cmd=" << in_cmd;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}
...
ndk::ScopedAStatus Performance::writeTmemoryHighWaterRatio(int32_t in_param, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": param=" << in_param;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}

ndk::ScopedAStatus Performance::writeTmemoryMemory(const std::string& in_str, int32_t* _aidl_return) {
...
ndk::ScopedAStatus Performance::writeUxState(const std::string& in_ux_state, const std::string& in_pid, const std::string& in_tid, int32_t* _aidl_return) {
    LOG(INFO) << __func__ << ": ux_state=" << in_ux_state << ", pid=" << in_pid << ", tid=" << in_tid;
    *_aidl_return = 0;
    return ndk::ScopedAStatus::ok();
}
