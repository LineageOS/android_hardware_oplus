...
class Performance : public BnPerformance {
    ndk::ScopedAStatus addAcmDirName(const std::string& in_dirname, int64_t in_flag, int32_t* _aidl_return) override;
    ndk::ScopedAStatus addAcmNomediaDirName(const std::string& in_dirname, int32_t* _aidl_return) override;
    ndk::ScopedAStatus addAcmPkgName(const std::string& in_pkgname, int64_t in_flag, int32_t* _aidl_return) override;
    ndk::ScopedAStatus addTaskTrackPid(int32_t in_group, int32_t in_pid, bool in_clear, int32_t* _aidl_return) override;
    ...
    ndk::ScopedAStatus delAcmNomediaDirName(const std::string& in_dirname, int32_t* _aidl_return) override;
    ...
    ndk::ScopedAStatus getExt4FragScore(const std::string& in_devpath, std::string* _aidl_return) override;
    ndk::ScopedAStatus getExt4FreefragInfo(const std::string& in_devpath, std::string* _aidl_return) override;
    ...
    ndk::ScopedAStatus getWakeThreadsAffinityOrdered(const std::string& in_handle, int32_t in_size, TaskWakeInfo* _aidl_return) override;
    ...
    ndk::ScopedAStatus hybridswap_memcg_para_read(int32_t in_action, const std::string& in_cgroup, std::string* _aidl_return) override;
    ndk::ScopedAStatus hybridswap_memcg_para_write(int32_t in_action, const std::string& in_cgroup, const std::string& in_str, int32_t* _aidl_return) override;
    ndk::ScopedAStatus hybridswap_zram_para_read(int32_t in_action, std::string* _aidl_return) override;
    ndk::ScopedAStatus hybridswap_zram_para_write(int32_t in_action, const std::string& in_str, int32_t* _aidl_return) override;
    ndk::ScopedAStatus isJankTaskTrackEnable(bool* _aidl_return) override;
    ndk::ScopedAStatus perProcessMemReadahead(int32_t in_uid, int32_t in_pid, int32_t in_type, int32_t* _aidl_return) override;
    ndk::ScopedAStatus perProcessMemReclaim(int32_t in_uid, int32_t in_pid, int32_t in_type, int32_t* _aidl_return) override;
    ...
    ndk::ScopedAStatus readIomonitorInfo(const std::string& in_procname, std::string* _aidl_return) override;
    ...
    ndk::ScopedAStatus readMemoryByPids(const std::vector<int32_t>& in_pids, int32_t in_flags, ProcMemStatRet* _aidl_return) override;
    ndk::ScopedAStatus readMemoryByUids(const std::vector<int32_t>& in_uids, int32_t in_flags, ProcMemStatRet* _aidl_return) override;
    ndk::ScopedAStatus readNandswapProc(const std::string& in_inProc, std::string* _aidl_return) override;
    ...
    ndk::ScopedAStatus readOplusReserve3(int32_t in_offset, int32_t in_len, std::string* _aidl_return) override;
    ...
    ndk::ScopedAStatus readStorageFeature(const std::string& in_name, const std::string& in_addr, const std::string& in_isMulti, std::string* _aidl_return) override;
    ndk::ScopedAStatus readTargetProcess(const std::string& in_buffer, std::string* _aidl_return) override;
    ...
    ndk::ScopedAStatus readUxTaskTrack(int32_t in_uPid, int32_t in_rPid, std::string* _aidl_return) override;
    ...
    ndk::ScopedAStatus searchAcmNomediaDirName(const std::string& in_dirname, int32_t* _aidl_return) override;
    ...
    ndk::ScopedAStatus setClmThreshold(const std::string& in_buffer, int32_t in_threshold_id) override;
    ndk::ScopedAStatus setDamonReclaimColdTime(int32_t in_cold_time, int32_t* _aidl_return) override;
    ndk::ScopedAStatus setDamonReclaimMonitoring(int32_t in_sample, int32_t in_aggr, int32_t* _aidl_return) override;
    ndk::ScopedAStatus setDamonReclaimQuota(int32_t in_quota_ms, int32_t in_quota_sz, int32_t in_reset_interval, int32_t* _aidl_return) override;
    ndk::ScopedAStatus setDamonReclaimWmarks(int32_t in_metric, int32_t in_high, int32_t in_mid, int32_t in_low, int32_t* _aidl_return) override;
    ndk::ScopedAStatus setExtSchedProp(const std::string& in_pid, const std::string& in_prop) override;
    ...
    ndk::ScopedAStatus setFreqGoverner(const std::string& in_gov_name, const std::vector<int32_t>& in_clusters, int32_t* _aidl_return) override;
    ndk::ScopedAStatus setImFlag(const std::string& in_pid, const std::string& in_im_flag) override;
    ndk::ScopedAStatus setProcessReclaim(const std::string& in_info, int32_t* _aidl_return) override;
    ...
    ndk::ScopedAStatus setTpdSerialParams(const std::string& in_params, int32_t* _aidl_return) override;
    ndk::ScopedAStatus setWakeSeedThread(const std::string& in_tid, bool in_identify_type, bool in_inUid, int32_t* _aidl_return) override;
    ...
    ndk::ScopedAStatus writeKmallocDebugCreateWithType(const std::string& in_type, int32_t* _aidl_return) override;
    ndk::ScopedAStatus writeMemMonitor(const std::string& in_buffer, int32_t* _aidl_return) override;
    ndk::ScopedAStatus writeMemleakDetectThread(int32_t in_memdect, int32_t* _aidl_return) override;
    ndk::ScopedAStatus writeMonitorStatus(const std::string& in_buffer, int32_t* _aidl_return) override;
    ndk::ScopedAStatus writeNandswapProc(const std::string& in_inProc, const std::string& in_cmd, int32_t* _aidl_return) override;
    ndk::ScopedAStatus writeOplusReserve3(int32_t in_offset, int32_t in_len, const std::string& in_info, int32_t* _aidl_return) override;
    ...
    ndk::ScopedAStatus writeStorageFeature(const std::string& in_name, const std::string& in_addr, const std::string& in_isMulti, const std::string& in_cmd, int32_t* _aidl_return) override;
    ...
    ndk::ScopedAStatus writeTmemoryMemory(const std::string& in_str, int32_t* _aidl_return) override;
    ndk::ScopedAStatus writeTmemorySwitch(int32_t in_param, int32_t* _aidl_return) override;
    ndk::ScopedAStatus writeUxState(const std::string& in_ux_state, const std::string& in_pid, const std::string& in_tid, int32_t* _aidl_return) override;
