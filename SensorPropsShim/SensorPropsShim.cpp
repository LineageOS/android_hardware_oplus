...
using SensorProps = aidl::android::hardware::biometrics::fingerprint::SensorProps;
...
_ZNK4aidl7android8hardware10biometrics11fingerprint11SensorProps13writeToParcelEP7AParcel(
    ...
    static auto writeToParcel = reinterpret_cast<
            ...
            dlsym(RTLD_NEXT,
                  "_ZNK4aidl7android8hardware10biometrics11fingerprint11SensorProps13writeToParcelE"
                  "P7AParcel"));
