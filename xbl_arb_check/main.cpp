...
struct HeaderV6 {
    // https://github.com/NichtsHsu/mbn-rs/blob/master/mbn/src/header.rs#L109
    uint32_t image_id;
...
struct HeaderV7 {
    // https://github.com/NichtsHsu/mbn-rs/blob/master/mbn/src/header.rs#L139
    uint32_t image_id;
    uint32_t header_version;
    ...
    struct {
        // https://github.com/NichtsHsu/mbn-rs/blob/master/mbn/src/metadata.rs#L42
        uint32_t major_version;
        uint32_t minor_version;
        uint32_t software_id;
        uint32_t app_id;
