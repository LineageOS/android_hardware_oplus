...
using IOplusBiometricsFingerprint = vendor::oplus::hardware::biometrics::fingerprint::V2_1::IBiometricsFingerprint;
...
private:
    ...
    sp<IBiometricsFingerprintClientCallbackEx> mOplusBiometricsFingerprintCallback;
};
