...
class AlertSliderDialog(private val context: Context, private val sysuiContext: Context) :
    ...
    private fun applyUiTheme(invertColors: Boolean) {
        ...
        val defaultForeground = getContrastingForegroundColor(bgColor, accentColor, isDark)

        val activeFg = if (invertColors) bgColor else defaultForeground
        val activeBg = if (invertColors) defaultForeground else bgColor
