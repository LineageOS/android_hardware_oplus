...
interface IOplusAppRadio {
  oneway void setCallback(vendor.oplus.hardware.appradioaidl.IOplusAppRadioResponse response, vendor.oplus.hardware.appradioaidl.IOplusAppRadioIndication indication);
