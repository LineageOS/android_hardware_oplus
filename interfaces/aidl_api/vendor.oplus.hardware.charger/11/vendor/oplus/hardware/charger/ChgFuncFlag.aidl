...
enum ChgFuncFlag {
  ...
  GET_CHARGER_INFO = 29,
  GET_CHARGER_INFO_UPDATE = 30,
  CHECK_FLAG_SUPPORT = 31,
  SET_CHG_PATH = 32,
  GET_BATTERY_GAUGE_CAR_C = 33,
  SET_BT_INFO = 34,
  GET_BDD_LEAK_CURR = 35,
  SET_REVERSE_CHG_INFO = 36,
  GET_REVERSE_CHG_INFO = 37,
  SET_WLSPEN_INFO = 38,
  SET_WLSPEN_DISCHG_SOC = 39,
  GET_VDM_INFO = 40,
  SET_PENCIL_TX_CHARGE_DISABLE = 41,
}
