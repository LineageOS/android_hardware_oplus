...
interface ISubsysRadioIndication {
  ...
  oneway void radioVodataEventInd(int type, in vendor.oplus.hardware.subsys_interface.subsys_radio.VodataEventInfo vodataEventInfo);
  oneway void radioAllCellInfoInd(int type, in vendor.oplus.hardware.subsys_interface.subsys_radio.CellInfos[] servingCellInfo, in vendor.oplus.hardware.subsys_interface.subsys_radio.NeighborCellInfos[] neighborCellInfos);
  oneway void radioNetworkActionResultInd(int type, in vendor.oplus.hardware.subsys_interface.subsys_radio.ActionResult[] result);
  oneway void radioSceneModeInd(int type, in vendor.oplus.hardware.subsys_interface.subsys_radio.SceneMode[] scenes);
  oneway void radioSmartNetworkSelectInd(int type, in vendor.oplus.hardware.subsys_interface.subsys_radio.SmartNetworkSelectInfo smartNetworkSelectInfo);
  oneway void radioImsRtpRedunEventInd(int type, in vendor.oplus.hardware.subsys_interface.subsys_radio.ImsRtpRedunEventInfo event);
  oneway void rxBoostStateInd(int type, in vendor.oplus.hardware.subsys_interface.subsys_radio.RxBoostStateInfo state);
  oneway void radioRrcStatusChangeInd(int type, in vendor.oplus.hardware.subsys_interface.subsys_radio.RrcStatusIndInfo rrcInfo);
  oneway void radioFenceStateChangeInd(int type, in vendor.oplus.hardware.subsys_interface.subsys_radio.FenceStateInfo[] fenceStateInfos);
  oneway void radioFenceRemovedInd(int type, in vendor.oplus.hardware.subsys_interface.subsys_radio.FenceRemovedInfo[] fenceRemovedInfos);
  oneway void radioFenceMergedInd(int type, in vendor.oplus.hardware.subsys_interface.subsys_radio.FenceMergedInfo[] fenceMergedInfos);
  oneway void radioFenceCreateInd(int type, in vendor.oplus.hardware.subsys_interface.subsys_radio.FenceCreatedInfo fenceCreatedInfo);
}
