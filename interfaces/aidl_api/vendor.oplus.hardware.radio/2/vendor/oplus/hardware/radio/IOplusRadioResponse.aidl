...
interface IOplusRadioResponse {
  ...
  void setNrModeResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, int mode);
  void getNrModeResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, int mode);
  ...
  void getVoNrEnabledResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, boolean enabled);
  void setEccListResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, String result);
  void SetHsrModeForListeningResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, int mode);
  void SetLogIdForListeningResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, int logId);
  ...
  void simlockReqResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, in byte[] data);
  void updateRegionlockBlobResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, in byte[] blob);
  ...
  void setNwCongestionCfgResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, in byte[] cfg);
  void setModemEsimStatusResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info);
  void getSimlockOperatorIdResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, int operatorId);
  void getSimlockFeestateResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, int state);
  void setSimlockFeestateResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info);
  void getSimlockUnlockStateResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, int state);
  void setSimlockFactoryResetTimeResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info);
  void getSimlockFactoryResetTimeResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, in byte[] time);
  void setSimlockActivateTimeResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info);
  void getSimlockActivateTimeResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, in byte[] time);
  ...
  void getSimlockDeviceLockStateResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, int state);
  ...
  void getSimlockMaxRetryResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, int maxRetry);
  void getSimlockCurrentRetryResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, int currentRetry);
  ...
  void getRegionlockSettingDataResponse(in vendor.oplus.hardware.radio.OplusRadioResponseInfo info, in byte[] data);
